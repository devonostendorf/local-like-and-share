(function( $ ) {
	...
	$(function() {
		$('.like_button').click(function(e) {
			...
			var btn_id = $this.attr('id');
	 		$.post(like_button_clicked_ajax_obj.ajax_url, {
	 			_ajax_nonce: like_button_clicked_ajax_obj.nonce,
	...
	$(function() {
		$('.share_button').click(function(e) {
			var $this = $(this);	 		
			var post_id = $this.data('post-id');
	 		$.post(share_button_clicked_ajax_obj.ajax_url, {
	 			_ajax_nonce: share_button_clicked_ajax_obj.nonce,
	 			action: "share_button_clicked",
	 			post_id: post_id,
	 		}, function(data) {
	 				  
	 			// Reload page after each share (to allow a user to share a single post multiple
	 			//		times without them having to manually refresh the page)
 				location.reload();
	 		});
	 	});
	});	
